...
def template_model(x, amp, z, fwhm, intr_fwhm, templ_disp=None,
    ...
    :param templ_fluxden_unit: Flux density unit of the template. This should be
    an astropy Unit, Quantity, IrreducibleUnit or CompositeUnit.
...
def setup_iron_template_T06(prefix, **kwargs):
    ...
    Sculptor models, but will be ignored. The prefix is automatically set by
    the setup function.
    :type prefix: string
    :param kwargs:
    :return: LMFIT model and parameters
...
def setup_split_iron_template_UV_VW01(prefix, **kwargs):
    """ Setup the Vestergaard & Wilkes 2001 iron template model subdivided into
     three separate models at 1200-1560, 1560-1875, 1875-2200.
...
def setup_split_iron_template_MgII_VW01(prefix, **kwargs):
    """ Setup the Vestergaard & Wilkes 2001 iron template model subdivided into
     three separate models at 2200-2660, 2660-3000, 3000-3500.
...
def calc_bolometric_luminosity(cont_lwav, cont_wav, reference='Shen2011'):
    ...
    reference string indicating the publication and continuum wavelength of
