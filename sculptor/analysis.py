...
def analyze_emission_feature(specfit, feature_name, model_names,
    ...
    if 'flux' in emfeat_meas:
        flux = get_integrated_flux(model_spec)
...
def _mcmc_analyze(specfit, specmodel_index, mcmc_df, continuum_dict,
                  ...
                  emfeat_meas=None, cont_meas=None, dispersion=None, width=10):
...
def analyse_resampled_results(foldername):
...
# ------------------------------------------------------------------------------
# Quasar/AGN specific function - Should be moved to separate module
# ------------------------------------------------------------------------------
